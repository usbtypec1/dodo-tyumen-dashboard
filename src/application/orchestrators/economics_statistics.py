...
from application.interactors.delivery_statistics_fetch import DeliveryStatisticsForMonthFetchInteractor
...
from application.interactors.unit_monthly_goals_fetch import UnitMonthlyGoalsFetchInteractor
...
class EconomicsStatisticsOrchestrator:
    ...
    produciton_statistics_fetch_interactor: ProductivityStatisticsForMonthFetchInteractor
    ...
    def execute(self):
        ...
        units_monthly_goals = []
        for unit_monthly_goals_fetch_intetactor in self.unit_monthly_goals_fetch_intetactors:
        ...
        unit_uuid_to_productivity_statistics = map_unit_uuid_to_item(production_statistics)
        ...
        for unit in self.units:
            ...
            unit_productivity_statistics = unit_uuid_to_productivity_statistics.get(unit.uuid)
